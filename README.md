...
Analyse average delivery cost

Control logistics expenses
...
Filter by region, carrier and period

Analyse the causes of deviations
...
Visualise the AS IS and TO BE processes

Link KPIs to process improvement
...
Verify whether delivery was completed within the SLA

Register delayed order when applicable

Register customer complaint when applicable
...
Identify delay cause when a risk is detected

Reassign carrier or adjust route when necessary
...
Generate a delay alert when necessary

Identify the affected order, carrier, and region
...
Evaluate whether delivery performance improved

Review the action plan and perform further investigation when required
...
Limited before execution

Validation before delivery

Delay identification

Mainly after SLA impact

Risk assessed earlier
...
Action effectiveness monitored
...
Close the action when effective

Revise the action plan and investigate further when improvement is not achieved
...
Monitor performance and define corrective actions

Logistics Supervisor

Identify delays and operational deviations

Business Analyst

Analyse requirements, processes, business rules, and improvement opportunities
...
Monitor returns and recurring customer issues

BI Analyst

Support KPI definitions and performance information

Carrier & Warehouse Teams

Execute preventive and corrective actions
